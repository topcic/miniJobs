        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ponuda = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nazivFirme = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    opstina_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Poslodavac_Opstina_opstina_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PitanjeThread", x => x.id);
                    table.ForeignKey(
                        name: "FK_PitanjeThread_Posao_posao_id",
                        column: x => x.posao_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_aplikantPosaoTip_Aplikant_aplikant_id",
                        column: x => x.aplikant_id,
                        principalTable: "Aplikant",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_aplikantPosaoTip_PosaoTip_posaoTip_id",
                        column: x => x.posaoTip_id,
                        principalTable: "PosaoTip",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datum_kreiranja = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pitanjeThread_id = table.Column<int>(type: "int", nullable: false),
                    korisnickiNalog_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Poruka", x => x.id);
                    table.ForeignKey(
                        name: "FK_Poruka_KorisnickiNalog_korisnickiNalog_id",
                        column: x => x.korisnickiNalog_id,
                        principalTable: "KorisnickiNalog",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Poruka_PitanjeThread_pitanjeThread_id",
                        column: x => x.pitanjeThread_id,
                        principalTable: "PitanjeThread",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_aplikantPosaoTip_aplikant_id",
                table: "aplikantPosaoTip",
                column: "aplikant_id");

            migrationBuilder.CreateIndex(
                name: "IX_aplikantPosaoTip_posaoTip_id",
                table: "aplikantPosaoTip",
                column: "posaoTip_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PitanjeThread_posao_id",
                table: "PitanjeThread",
                column: "posao_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Poruka_korisnickiNalog_id",
                table: "Poruka",
                column: "korisnickiNalog_id");

            migrationBuilder.CreateIndex(
                name: "IX_Poruka_pitanjeThread_id",
                table: "Poruka",
                column: "pitanjeThread_id");
